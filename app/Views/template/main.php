        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?php echo base_url() ?>">
                <div class="sidebar-brand-icon rotate-n-0">
                    <img src="<?php echo base_url('../vendor/img/logo_grcl.png') ?>" alt="logogrcl" width="30" height="30">
                </div>
                <div class="sidebar-brand-text mx-3">GRCL <sup>app</sup></div>
            </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="<?php echo base_url('/admin/murid') ?>">Murid</a>
                        <a class="collapse-item" href="<?php echo base_url('/admin/jadwal') ?>">Jadwal</a>
                    </div>
                </div>
            </li>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Judul sesuai Session</h1>
                        <!-- <a href="#" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                                class="fas fa-download fa-sm text-white-50"></i> Generate Report</a> -->
                    </div>


                    <!-----------------------------------------untuk konten disini semua -->
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; zeratech 2025</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
